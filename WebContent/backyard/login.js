...
//	}
	...
	LoginCommon.prototype.login = function() {
		...
		$.ajax({
			...
			"dataType" : "json",
			"data" : {
				"accountNumber" : $(".login-container #username").val(),
				"accountPwd" : $(".login-container #password").val()
			},
...
//				}
				if (json.result) {
					// 本地存储数据
					sessionStorage.accountNumber = json.accountNumber;
					sessionStorage.accountName = json.accountName;
					sessionStorage.accountStatus = json.accountStatus;
...
//					sessionStorage.permissions = temp;
					...
					location.href = "/OA/backyard/index.html";
